...
import (
	...
	storage "github.com/jakule/codersranktask/go/storage"
)
...
func (m *MockStorage) Delete(secretID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", secretID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delete indicates an expected call of Delete
func (mr *MockStorageMockRecorder) Delete(secretID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockStorage)(nil).Delete), secretID)
}
